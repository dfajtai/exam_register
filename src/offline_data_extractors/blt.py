...
def blt_data_parser(input_data_path):
    ...
    res = __blt_retro_pdf_data_extract_single_page__(pdf_path=input_data_path, colnames=default_cols )
    return res

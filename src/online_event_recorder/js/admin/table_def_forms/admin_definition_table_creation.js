function createAdminTable(container, table_id, height){
    ...
    toolbar.append($("<button/>").attr("id","toolbar_edit").addClass("btn btn-dark admin-table-toolbar-btn").html($("<i/>").addClass("fa fa-pen-to-square me-2").attr("aria-hidden","true")).append("Edit Selected"));
